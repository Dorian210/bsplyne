...
ax.plot(ctrl_pts1[0], -ctrl_pts1[1], '#999999')
ax.scatter(ctrl_pts2[0], -ctrl_pts2[1], c='#999999')
ax.plot(ctrl_pts2[0], -ctrl_pts2[1], '#999999')
ax.plot(x1, -y1, '#000000')
ax.plot(x2, -y2, '#000000')
ax.set_aspect(1)
ax.set_axis_off()
fig.savefig(os.path.join(os.path.dirname(__file__), "logo.png"), bbox_inches='tight')
...
ax.plot(ctrl_ptsb1[0], -ctrl_ptsb1[1], '#999999')
ax.scatter(ctrl_ptsb2[0], -ctrl_ptsb2[1], c='#999999')
ax.plot(ctrl_ptsb2[0], -ctrl_ptsb2[1], '#999999')
ax.plot(xb1, -yb1, '#000000')
ax.plot(xb2, -yb2, '#000000')
ax.set_aspect(1)
ax.set_axis_off()

bspline1.plot(ctrl_ptsb1*np.array([1, -1])[:, None], n_eval_per_elem=20)
ax = plt.gca()
bspline2.plot(ctrl_ptsb2*np.array([1, -1])[:, None], n_eval_per_elem=20, ax=ax)
