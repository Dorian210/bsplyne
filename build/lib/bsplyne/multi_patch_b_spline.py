...
class CouplesBSplineBorder:
    ...
    def compute_border_couple_DN(self, couple_ind: int, splines: list[BSpline], XI2_border: list[np.ndarray], k2: Union[int, list[int]]=0):
        ...
        XI2 = XI2_border[:self.axes2[couple_ind]] + [np.array([spline2.bases[self.axes2[couple_ind]].span[self.front_sides2[couple_ind]]])] + XI2_border[self.axes2[couple_ind]:]
        ...
        XI1 = XI1_border[:self.axes1[couple_ind]] + [np.array([spline1.bases[self.axes1[couple_ind]].span[self.front_sides1[couple_ind]]])] + XI1_border[self.axes1[couple_ind]:]
